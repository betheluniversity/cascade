...
class T(object):
    ...
    def get_type_class_name_map(self, type):
        ...
        type_class_name_map = {
            ...
            self.ASSETFACTORYCONTAINER: 'AssetFactoryContainer',
            self.CONNECTORCONTAINER: 'ConnectorContainer',
            self.CONTENTTYPE: 'ContentType',
            self.CONTENTTYPECONTAINER: 'ContentTypeContainer',
            self.DATADEFINITION: 'DataDefinition',
            self.DATADEFINITIONCONTAINER: 'DataDefinitionContainer',
            self.DESTINATION: 'Destination',
            self.FACEBOOKCONNECTOR: 'FacebookConnector',
            self.FEEDBLOCK: 'FeedBlock',
            self.FILE: 'File',
            self.FOLDER: 'Folder',
            self.GOOGLEANALYTICSCONNECTOR: 'GoogleAnalyticsConnector',
            self.GROUP: 'Group',
            self.INDEXBLOCK: 'IndexBlock',
            self.METADATASET: 'MetadataSet',
            self.METADATASETCONTAINER: 'MetadataSetContainer',
            self.PAGE: 'page.Page',
            self.PAGECONFIGURATIONSET: 'PageConfigurationSet',
            self.PAGECONFIGURATIONSETCONTAINER: 'PageConfigurationSetContainer',
            self.PUBLISHSET: 'PublishSet',
            self.PUBLISHSETCONTAINER: 'PublishSetContainer',
            self.REFERENCE: 'Reference',
            self.ROLE: 'Role',
            self.SCRIPTFORMAT: 'ScriptFormat',
            self.SITE: 'Site',
            self.SITEDESTINATIONCONTAINER: 'SiteDestinationContainer',
            self.SYMLINK: 'Symlink',
            self.TEMPLATE: 'Template',
            self.TEXTBLOCK: 'TextBlock',
            self.TRANSPORTDB: 'DatabaseTransport',
            self.TRANSPORTFS: 'FileSystemTransport',
            self.TRANSPORTFTP: 'FtpTransport',
            self.TRANSPORTCONTAINER: 'TransportContainer',
            self.TWITTERCONNECTOR: 'TwitterConnector',
            self.USER: 'User',
            self.WORDPRESSCONNECTOR: 'WordPressConnector',
            self.WORKFLOWDEFINITION: 'WorkflowDefinition',
            self.WORKFLOWDEFINITIONCONTAINER: 'WorkflowDefinitionContainer',
            self.XHTMLDATADEFINITIONBLOCK: 'DataDefinitionBlock',
    ...
    type_property_name_map = {
        ASSETFACTORY: properties.P.ASSETFACTORY,
        ASSETFACTORYCONTAINER: properties.P.ASSETFACTORYCONTAINER,
        CONNECTORCONTAINER: properties.P.CONNECTORCONTAINER,
        CONTENTTYPE: properties.P.CONTENTTYPE,
        CONTENTTYPECONTAINER: properties.P.CONTENTTYPECONTAINER,
        DATADEFINITION: properties.P.DATADEFINITION,
        DATADEFINITIONCONTAINER: properties.P.DATADEFINITIONCONTAINER,
        DESTINATION: properties.P.DESTINATION,
        FACEBOOKCONNECTOR: properties.P.FACEBOOKCONNECTOR,
        FEEDBLOCK: properties.P.FEEDBLOCK,
        FILE: properties.P.FILE,
        FOLDER: properties.P.FOLDER,
        GOOGLEANALYTICSCONNECTOR: properties.P.GOOGLEANALYTICSCONNECTOR,
        GROUP: properties.P.GROUP,
        INDEXBLOCK: properties.P.INDEXBLOCK,
        METADATASET: properties.P.METADATASET,
        METADATASETCONTAINER: properties.P.METADATASETCONTAINER,
        PAGE: properties.P.PAGE,
        PAGECONFIGURATIONSET: properties.P.PAGECONFIGURATIONSET,
        PAGECONFIGURATIONSETCONTAINER: properties.P.PAGECONFIGURATIONSETCONTAINER,
        PUBLISHSET: properties.P.PUBLISHSET,
        PUBLISHSETCONTAINER: properties.P.PUBLISHSETCONTAINER,
        REFERENCE: properties.P.REFERENCE,
        ROLE: properties.P.ROLE,
        SCRIPTFORMAT: properties.P.SCRIPTFORMAT,
        SITE: properties.P.SITE,
        SITEDESTINATIONCONTAINER: properties.P.SITEDESTINATIONCONTAINER,
        SYMLINK: properties.P.SYMLINK,
        TEMPLATE: properties.P.TEMPLATE,
        TEXTBLOCK: properties.P.TEXTBLOCK,
        TRANSPORTDB: properties.P.DATABASETRANSPORT,
        TRANSPORTFS: properties.P.FILESYSTEMTRANSPORT,
        TRANSPORTFTP: properties.P.FTPTRANSPORT,
        TRANSPORTCONTAINER: properties.P.TRANSPORTCONTAINER,
        TWITTERCONNECTOR: properties.P.TWITTERCONNECTOR,
        USER: properties.P.USER,
        WORDPRESSCONNECTOR: properties.P.WORDPRESSCONNECTOR,
        WORKFLOWDEFINITION: properties.P.WORKFLOWDEFINITION,
        WORKFLOWDEFINITIONCONTAINER: properties.P.WORKFLOWDEFINITIONCONTAINER,
        XHTMLDATADEFINITIONBLOCK: properties.P.XHTMLDATADEFINITIONBLOCK,
        XMLBLOCK: properties.P.XMLBLOCK,
