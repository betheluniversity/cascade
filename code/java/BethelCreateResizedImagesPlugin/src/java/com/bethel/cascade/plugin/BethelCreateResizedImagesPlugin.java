package com.bethel.cascade.plugin;
...
import com.hannonhill.cascade.util.ImageUtil;
 ...
 * @since 4.3
 */
public final class BethelCreateResizedImagesPlugin extends BaseAssetFactoryPlugin
{
    private static final Logger LOG = getLogger(BethelCreateResizedImagesPlugin.class);

    private static final String DESCRIPTION_KEY = "plugin.asset.factory.description.bethelcreateresizedimagesplugin";
    private static final String NAME_KEY = "plugin.asset.factory.name.bethelcreateresizedimagesplugin";

    /** The number of additional images that will be created */
    private static final String PARAM_NUM_ADDITIONAL_IMAGES_NAME_KEY = "assetfactory.plugin.bethelcreateresized.param.name.numadditionalimages";
    private static final String PARAM_NUM_ADDITIONAL_IMAGES_DESCRIPTION_KEY = "assetfactory.plugin.bethelcreateresized.param.description.numadditionalimages";

    /** Comma delimited list of widths of the new images that will be created */
    private static final String PARAM_WIDTHS_NAME_KEY = "assetfactory.plugin.bethelcreateresized.param.name.width";
    private static final String PARAM_WIDTHS_DESCRIPTION_KEY = "assetfactory.plugin.bethelcreateresized.param.description.width";

    /** Comma delimited list of heights of the new images that will be created */
    private static final String PARAM_HEIGHTS_NAME_KEY = "assetfactory.plugin.bethelcreateresized.param.name.height";
    private static final String PARAM_HEIGHTS_DESCRIPTION_KEY = "assetfactory.plugin.bethelcreateresized.param.description.height";
    ...
    {
        return StringUtil.concat(extension.getBaseName(), "-", newDimensions.width,".", extension.getExtension());
    }
    ...
    private final void validateParameters() throws PluginException
    {
        ...
        {
            throw new PluginException("BethelCreateResizedImagesPlugin is missing required parameter: number of additional images.");
        }
        ...
        {
            throw new PluginException("BethelCreateResizedImagesPlugin required parameter number of additional images is malformed. Must be an integer: "
                    + e.getMessage(), e);
        }
        ...
        if (widths == null && heights == null)
        {
            throw new PluginException(
                    "BethelCreateResizedImagesPlugin is missing required parameter: comma-delimited list of resized image widths and/or heights.");
        }
    ...
    private static final byte[] getResizedImage(final BufferedImage original, final Dimension newDimensions, String extension) throws PluginException
    {
        try
        {
            BufferedImage out = ImageUtil.resize(original, newDimensions.width, newDimensions.height);
