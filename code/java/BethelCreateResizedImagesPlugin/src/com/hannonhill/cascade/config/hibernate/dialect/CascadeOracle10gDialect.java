...
/**
 * Our own version of the Oracle10g dialect so we have support for doubles in Hibernate
 ...
 * @since   5.0
 */
public class CascadeOracle10gDialect extends Oracle10gDialect
{
    public CascadeOracle10gDialect()
    {
        super();
